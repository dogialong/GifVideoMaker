...
public class GPUImage {
    ...
    public GPUImage(final Context context, GPUImageFilter mFilter) {
        if (!supportsOpenGLES2(context)) {
            throw new IllegalStateException("OpenGL ES 2.0 is not supported on this phone.");
        }
    ...
    public static void getBitmapForFilter(Bitmap bitmap, GPUImageFilter gpuImageFilter, CreatFilterImage creatFilterImage) {
        GPUImageRenderer renderer = new GPUImageRenderer(gpuImageFilter);
        PixelBuffer buffer = new PixelBuffer(bitmap.getWidth(), bitmap.getHeight());
        buffer.setRenderer(renderer);
        renderer.setImageBitmap(bitmap, false);
        Bitmap result = buffer.getBitmap();
        creatFilterImage.onSucces(result);
    }
     ...
     */
    @Deprecated
    public void saveToPictures(int indexFrame, final String fileName,
                               final OnPictureSavedListener listener) {
        saveToPictures(indexFrame, mCurrentBitmap, fileName, listener);
    }
     ...
     */
    @Deprecated
    public void saveToPictures(int indexFrame, final Bitmap bitmap, final String fileName,
                               final OnPictureSavedListener listener) {
        new SaveTask(indexFrame, bitmap, fileName, listener).execute();
    }
    ...
    private class SaveTask extends AsyncTask<Void, Void, Void> {
        ...
        public SaveTask(int indexFrame, final Bitmap bitmap, final String fileName,
                        final OnPictureSavedListener listener) {
            mBitmap = bitmap;
            mFileName = fileName;
            mListener = listener;
        ...
        private void saveImage(final String fileName, final Bitmap image) {
            ...
            try {
                ...
                mListener.onPictureSaved(indexFrame);
    ...
    public interface OnPictureSavedListener {
        void onPictureSaved(int frameSucces);
    }
    ...
    public interface CreatFilterImage {
