...
import static pl.droidsonroids.gif.InvalidationHandlerCustom.MSG_TYPE_INVALIDATION;

class RenderTaskCustom extends SafeRunnableCustom {

    RenderTaskCustom(GifDrawableCustom gifDrawable) {
        super(gifDrawable);
    }
