...
public class SliderBar extends View implements ThemeManager.OnThemeChangedListener {
    ...
    private int mTextColor = 0xffc517;
    ...
    public interface OnPositionChangeListener {
         ...
         */
        void onPositionChanged(SliderBar view, boolean fromUser, float oldPos, float newPos, int oldValue, int newValue);
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        canvas.drawCircle(x, y, mThumbCurrentRadius+20, mPaint);



        mPaint.setColor(filledPrimaryColor);
        float radius = mThumbCurrentRadius - mThumbBorderSize;
        mPaint.setStyle(Paint.Style.FILL);
