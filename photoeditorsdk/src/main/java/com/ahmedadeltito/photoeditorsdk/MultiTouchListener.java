...
class MultiTouchListener implements OnTouchListener {
    ...
    MultiTouchListener(View deleteView, RelativeLayout parentView,List<View> addViews,
                        ...
                        if (((RelativeLayout) view).getChildAt(1) instanceof TextView) {
                            if (onMultiTouchListener != null) {
                                onMultiTouchListener.onEditTextClickListener(
                                        ((TextView) ((RelativeLayout) view).getChildAt(1)).getText().toString(), ((TextView) ((RelativeLayout) view).getChildAt(1)).getCurrentTextColor(), ((TextView) ((RelativeLayout) view).getChildAt(1)).getTypeface(), view, addViews.indexOf(view));
    ...
    interface OnMultiTouchListener {
        void onEditTextClickListener(String text, int colorCode, Typeface typeface,View view,int positon);
