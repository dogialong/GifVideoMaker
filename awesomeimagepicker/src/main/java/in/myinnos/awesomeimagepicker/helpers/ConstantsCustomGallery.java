...
public class ConstantsCustomGallery {
    ...
    public static final int REQUEST_CODE_ADD_IMAGE = 2006;
    ...
    public static final String INTENT_EXTRA_STRING = "strings";
    ...
    public static final String LIST_SELECTED = "list_seleted";
