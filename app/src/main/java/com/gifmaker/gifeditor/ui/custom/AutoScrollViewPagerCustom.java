...
/**
 * Created by longdg on 2017-08-09.
 */

public class AutoScrollViewPagerCustom extends ViewPager {
    ...
    public AutoScrollViewPagerCustom(Context paramContext) {
        super(paramContext);
        this.init();
    }

    public AutoScrollViewPagerCustom(Context paramContext, AttributeSet paramAttributeSet) {
        super(paramContext, paramAttributeSet);
        this.init();
    }

    private void init() {
        this.handler = new AutoScrollViewPagerCustom.MyHandler();
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch(msg.what) {
                case 0:
                    AutoScrollViewPagerCustom.this.scrollOnce();
                    AutoScrollViewPagerCustom.this.sendScrollMessage(AutoScrollViewPagerCustom.this.interval);
                default:
            }
        }
    }
